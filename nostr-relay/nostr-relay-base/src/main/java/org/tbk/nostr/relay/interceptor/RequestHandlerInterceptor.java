...
public interface RequestHandlerInterceptor {
     ...
     */
    default boolean preHandle(NostrRequestContext context, Request request) throws Exception {
        return true;
    }
     ...
     * @throws Exception in case of errors
     */
    default void postHandle(NostrRequestContext context, Request request) throws Exception {
    }
