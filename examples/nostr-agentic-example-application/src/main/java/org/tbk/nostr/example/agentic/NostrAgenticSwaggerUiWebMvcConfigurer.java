...
class NostrAgenticSwaggerUiWebMvcConfigurer implements WebMvcConfigurer {
    ...
    OpenAPI openApi() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .title("nostr-agentic-example-application")
                        .description("Nostr Agentic Example Application")
                        .license(new License()
                                .name("Apache-2.0")
