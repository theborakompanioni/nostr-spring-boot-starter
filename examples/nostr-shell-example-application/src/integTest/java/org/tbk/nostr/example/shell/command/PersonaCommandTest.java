...
class PersonaCommandTest {
    ...
    @Test
    void testPersonaAlice0() throws Exception {
        String command = """
                persona --name alice
                """;
        ...
        ShellAssertions.assertThat(screen)
                ...
                .containsText("\"keyPath\" : \"m/44'/1237'/0'/0/0\"")
    ...
    @Test
    void testPersonaAlice15() throws Exception {
        String command = """
                persona --name alice --account 15
                """;
        ...
        ShellAssertions.assertThat(screen)
                ...
                .containsText("\"entropy\" : \"2bd806c97f0e00af1a1fc3328fa763a9\"")
                .containsText("\"mnemonic\" : \"cloth scan rather wrap theme fiscal half wear crater large suggest fancy\"")
                .containsText("\"keyPath\" : \"m/44'/1237'/15'/0/0\"")
    ...
    @Test
    void testPersonaBob0() throws Exception {
        String command = """
                persona --name bob
                """;
    ...
    @Test
    void testPersonaBob15() throws Exception {
        String command = """
                persona --name bob --account 15
                """;
