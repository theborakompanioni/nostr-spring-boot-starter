...
## [Unreleased]
### Changed
- upgrade: update spring-boot from v3.5.8 to v4.1.0
- upgrade: update spring-shell from v3.4.1 to v4.0.3
- upgrade: update spring-shell from v1.1.8 to v2.0.0
...
- upgrade: update spring-ai from v1.0.0-M5 to v1.1.0
- upgrade: update springdoc-openapi from v2.3.0 to v2.8.12
- upgrade: update nostr-proto from v0.2.0 to v0.4.0
