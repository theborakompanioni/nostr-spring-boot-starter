...
@ConfigurationProperties(
        prefix = "org.tbk.nostr.template",
        ignoreUnknownFields = false
)
@Getter
@AllArgsConstructor(onConstructor = @__(@ConstructorBinding))
public class NostrTemplateProperties implements Validator {
    ...
    public boolean supports(Class<?> clazz) {
        return clazz == NostrTemplateProperties.class;
    }

    @Override
    public void validate(Object target, Errors errors) {
        NostrTemplateProperties properties = (NostrTemplateProperties) target;
